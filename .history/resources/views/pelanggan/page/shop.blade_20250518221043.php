    ...
    <div class="row mt-4">
        ...
        <div class="card" style="width:220px;">
            <div class="card-header m-auto" style="height:100%;width:100%;">
                <img src="{{ asset('storage/product/' . $p->foto) }}" alt="Slingbag" style="width: 100%;;height:200px; object-fit: cover; padding:0;">
            ...
            <div class="card-footer d-flex flex-row justify-content-between align-item-center">
                <p class="m-0" style="font-size: 16px; font-weight: 600;"><span>IDR </span>{{number_format($p->price)}}</p>
